# Prior-version native workflows

Historical V9/V10/Slider V1 examples remain available unchanged. Start with the [V11 workflows](../../example_workflows/README.md) for current use.
...
File: [krea-slider-v1-showcase-workflow.json](../../example_workflows/krea-slider-v1-showcase-workflow.json)
...
Queue once, compare the pair, then drag values; with study reuse on, re-runs only re-encode the sliders you changed. The full manual - the dial table, the ten-slider audit, and the slider-writing cookbook - is the [Concept Slider guide](slider-v1/concept-slider-v1.md).

## V10 Full Showcase

File: [krea-v10-full-showcase-workflow.json](../../example_workflows/krea-v10-full-showcase-workflow.json)
...
File: [krea-v10-counter-example-workflow.json](../../example_workflows/krea-v10-counter-example-workflow.json)
...
File: [krea-v10-reference-stack-workflow.json](../../example_workflows/krea-v10-reference-stack-workflow.json)
...
File: [krea-v10-starter-recipe-workflow.json](../../example_workflows/krea-v10-starter-recipe-workflow.json)
...
File: [krea-v9-full-showcase-workflow.json](../../example_workflows/krea-v9-full-showcase-workflow.json)
...
File: [krea-v9-no-prompt-style-transfer-workflow.json](../../example_workflows/krea-v9-no-prompt-style-transfer-workflow.json)
...
File: [krea-v9-reference-stack-workflow.json](../../example_workflows/krea-v9-reference-stack-workflow.json)
...
- [Concept Slider V1 guide](slider-v1/concept-slider-v1.md)
- [Krea 2 V10 visual user guide](v10/krea-v10-user-guide.html)
- [Krea 2 V10 documentation index](v10/krea-v10-documentation-index.md)
- [KG Krea 2 Image Guide Card V10](v10/nodes/kg-krea-2-image-guide-card-v10.md)
- [KG Krea 2 Reference Stack Encoder V10](v10/nodes/kg-krea-2-reference-stack-encoder-v10.md)
- [Krea 2 V9 visual user guide](v9/krea-v9-user-guide.html)
- [Krea 2 V9 documentation index](v9/krea-v9-documentation-index.md)
- [KG Krea 2 Image Guide Card V9](v9/nodes/kg-krea-2-image-guide-card-v9.md)
- [KG Krea 2 Reference Stack Encoder V9](v9/nodes/kg-krea-2-reference-stack-encoder-v9.md)
