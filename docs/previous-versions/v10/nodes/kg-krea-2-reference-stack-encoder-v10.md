...
Class: `KGTextEncodeKreaImageReferencesV10`<br>
Node key: `KGTextEncodeKreaImageReferencesV10`<br>
Category: `advanced/conditioning`<br>
Source: `kg_krea_v10/encoder.py`<br>
